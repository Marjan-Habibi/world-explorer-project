...
export default async function CountryDetailsPage({ params }) {
  ...
  return (
    <div>
      <Link href="/countries" style={{ color: "#3b82f6", textDecoration: "none", display: "inline-block", marginBottom: "1.5rem" }}>
        ← Back to Countries
      </Link>
          ...
          <div style={{ flex: "2", padding: "2rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "1rem" }}>
              <div>
                ...
                <p><strong>🗺️ Region:</strong> {country.region}</p>
                <p><strong>📍 Subregion:</strong> {country.subregion || "N/A"}</p>
                <p><strong>👥 Population:</strong> {country.population.toLocaleString()}</p>
              </div>
              <div>
                <p><strong>🗣️ Languages:</strong> {getLanguages()}</p>
